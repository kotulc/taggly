...
```
taggly key "Language models are transforming how we interact with text and data." --top-n 10
```

**API**

```bash
curl -X POST "http://localhost:8000/key?top_n=10" \
...
```
Usage: taggly key [OPTIONS] CONTENT                                                                                                                                                                   
